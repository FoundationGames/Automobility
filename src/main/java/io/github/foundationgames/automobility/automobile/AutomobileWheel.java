...
public record AutomobileWheel(
    ...
    public static final AutomobileWheel STANDARD = REGISTRY.register(
            new AutomobileWheel(Automobility.id("standard"), 0.5f, new WheelModel(3, Automobility.id("textures/entity/automobile/wheel/standard.png"), StandardWheelModel::new))
    );

    public static final AutomobileWheel OFF_ROAD = REGISTRY.register(
            new AutomobileWheel(Automobility.id("off_road"), 1.0f, new WheelModel(8, TEMP_ID, EmptyModel::new))
    );

    public static final AutomobileWheel STEEL = REGISTRY.register(
            new AutomobileWheel(Automobility.id("steel"), 0.25f, new WheelModel(1.5f, TEMP_ID, EmptyModel::new))
    );

    public static final AutomobileWheel INFLATABLE = REGISTRY.register(
            new AutomobileWheel(Automobility.id("inflatable"), 0.75f, new WheelModel(4f, TEMP_ID, EmptyModel::new), Ability.HYDROPLANE)
    );
