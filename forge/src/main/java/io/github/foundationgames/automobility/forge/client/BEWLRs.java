...
public class BEWLRs {
    ...
    public static void add(Item item, HexCons<ItemStack, ItemTransforms.TransformType, PoseStack, MultiBufferSource, Integer, Integer> renderer) {
     ...
     */
    public static boolean tryRender(ItemStack stack, ItemTransforms.TransformType transform, PoseStack pose, MultiBufferSource buffers, int light, int overlay) {
